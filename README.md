...
| `termux-base-bootstrap.sh` | Idempotent bootstrap of the base Termux environment: essential packages, storage access, automation directories, rclone ready for config |
